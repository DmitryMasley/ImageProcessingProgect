...
void Workspace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ImageAdded((*reinterpret_cast< std::add_pointer_t<cv::Mat>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->addImage(); break;
        case 2: _t->showImage((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 3: _t->removeSelectedImage(); break;
        default: ;
        }
        ...
        {
            using _t = void (Workspace::*)(cv::Mat , QString );
            if (_t _q_method = &Workspace::ImageAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Workspace::ImageAdded(cv::Mat _t1, QString _t2)
{
